...
public class Tietovisa {
	public static void main(String[] args) {
		...
		/*
		 * Main-metodissa kutsutaan kolmea muuta metodia terveTuloajaNimi();,
		 * visailua(); sekä palaute(pisteet); Tässä metodissa myös tulostetaan kolme
		 * kommenttia, käytetään metodista terveTuloajaNimi();-metodista saatua pelaajan
		 * nimeä Metodissa hyödynnetään myös visailua();-metodista saatua pelaajan
		 * kerryttämää pistemäärää
		 */
		...
		System.out.println("Katsotaan, kuinka hyvin onnistuit!");
	...
	public static String terveTuloajaNimi() {
		...
		System.out.println();
		// Kysytään nimi ja toivotetaan pelaaja tervetulleeksi
	...
	public static void palaute(int pisteet) {
		...
		if (pisteet >= 0 && pisteet <= 5) {
			...
			System.out.println("Se meni ihan hyvin!");
		} else if (pisteet >= 11 && pisteet <= 15) {
			System.out.println("Hyvä sinä!");
		} else {
